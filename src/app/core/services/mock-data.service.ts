...
export class MockDataService {
  ...
  private courses: Course[] = [
    // Frontend Development
    {
      ...
      description: 'Master Angular from beginner to advanced with real projects, including Angular 17+ features, standalone components, and modern development practices.',
    ...
    },
    {
      ...
      description: 'Learn modern React with hooks, context, and best practices. Build real-world applications with the latest React features.',
    ...
    },
    {
      ...
      description: 'Master Vue.js 3 with Composition API, Pinia state management, and modern Vue development patterns.',
      instructor: 'Evan You',
      platform: 'coursera',
      url: 'https://www.coursera.org/learn/vue-js-3',
      imageUrl: '/assets/images/vue-course.jpg',
      price: 49.99,
      currency: 'USD',
      rating: 4.7,
      reviewCount: 5621,
    ...
    },
    {
      ...
      description: 'Learn modern JavaScript from basics to advanced concepts including ES2024 features, async programming, and design patterns.',
      instructor: 'Jonas Schmedtmann',
      platform: 'udemy',
      url: 'https://www.udemy.com/course/the-complete-javascript-course/',
      imageUrl: '/assets/images/js-course.jpg',
      price: 79.99,
      currency: 'USD',
      rating: 4.9,
      reviewCount: 18765,
    ...
    },
    {
      ...
      description: 'Transform your JavaScript skills with TypeScript. Learn type safety, generics, decorators, and advanced TypeScript patterns.',
      instructor: 'Matt Pocock',
      platform: 'youtube',
      url: 'https://www.youtube.com/playlist?list=PLYvdvJlnTOjF6aJsWWAt7kZRJvzw-en8B',
      imageUrl: '/assets/images/typescript-course.jpg',
      price: 0,
      currency: 'USD',
      rating: 4.8,
      reviewCount: 7234,
    ...
    // Backend Development
    {
      ...
      description: 'Build scalable backend applications with Node.js, Express, MongoDB, and modern development practices.',
      instructor: 'Andrew Mead',
      platform: 'udemy',
      url: 'https://www.udemy.com/course/the-complete-nodejs-developer-course-2/',
      imageUrl: '/assets/images/nodejs-course.jpg',
      price: 94.99,
      currency: 'USD',
      rating: 4.7,
      reviewCount: 15432,
    ...
    },
    {
      ...
      description: 'Build powerful REST APIs with Django REST Framework. Learn authentication, serialization, and API best practices.',
      instructor: 'Corey Schafer',
      platform: 'youtube',
      url: 'https://www.youtube.com/playlist?list=PL-osiE80TeTtoQCKZ03TU5fNfx2UY6U4p',
      imageUrl: '/assets/images/django-course.jpg',
      price: 0,
      currency: 'USD',
      rating: 4.9,
      reviewCount: 9876,
    ...
    },
    {
      ...
      description: 'Master Spring Boot microservices architecture with Docker, Kubernetes, and cloud deployment strategies.',
      instructor: 'John Thompson',
      platform: 'coursera',
      url: 'https://www.coursera.org/specializations/spring-boot-microservices',
      imageUrl: '/assets/images/spring-course.jpg',
      price: 79.99,
      currency: 'USD',
      rating: 4.6,
      reviewCount: 4321,
    ...
    // Full Stack Development
    {
      ...
      description: 'Build full-stack applications with MongoDB, Express, Angular, and Node.js. Complete project-based learning.',
      instructor: 'Maximilian Schwarzmüller',
      platform: 'udemy',
      url: 'https://www.udemy.com/course/angular-2-and-nodejs-the-practical-guide/',
      imageUrl: '/assets/images/mean-course.jpg',
      price: 89.99,
      currency: 'USD',
      rating: 4.5,
      reviewCount: 8765,
    ...
    },
    {
      ...
      description: 'Build modern full-stack applications with React, GraphQL, Apollo Client, and Node.js backend.',
      instructor: 'Stephen Grider',
      platform: 'udemy',
      url: 'https://www.udemy.com/course/graphql-with-react-course/',
      imageUrl: '/assets/images/react-graphql-course.jpg',
      price: 84.99,
      currency: 'USD',
      rating: 4.7,
      reviewCount: 6543,
    ...
    // Mobile Development
    {
      ...
      description: 'Build native mobile apps for iOS and Android using React Native. Learn navigation, state management, and native modules.',
      instructor: 'Stephen Grider',
      platform: 'udemy',
      url: 'https://www.udemy.com/course/the-complete-react-native-and-redux-course/',
      imageUrl: '/assets/images/react-native-course.jpg',
      price: 89.99,
      currency: 'USD',
      rating: 4.6,
      reviewCount: 11234,
    ...
    },
    {
      ...
      description: 'Create beautiful native apps for iOS and Android with Flutter. Learn Dart, widgets, state management, and deployment.',
      instructor: 'Angela Yu',
      platform: 'udemy',
      url: 'https://www.udemy.com/course/flutter-bootcamp-with-dart/',
      imageUrl: '/assets/images/flutter-course.jpg',
      price: 94.99,
      currency: 'USD',
      rating: 4.8,
      reviewCount: 9876,
    ...
    // DevOps & Cloud
    {
      ...
      description: 'Master containerization with Docker and orchestration with Kubernetes. Learn CI/CD, monitoring, and production deployment.',
      instructor: 'Stephen Grider',
      platform: 'udemy',
      url: 'https://www.udemy.com/course/docker-and-kubernetes-the-complete-guide/',
      imageUrl: '/assets/images/docker-k8s-course.jpg',
      price: 89.99,
      currency: 'USD',
      rating: 4.7,
      reviewCount: 13456,
    ...
    },
    {
      ...
      description: 'Prepare for AWS Solutions Architect certification. Learn cloud architecture, security, and best practices.',
    ...
    },
    {
      ...
      description: 'Complete machine learning course covering supervised, unsupervised learning, and deep learning with practical projects.',
    ...
    // Free Courses from FreeCodeCamp
    {
      ...
      description: 'Learn HTML, CSS, and responsive design principles. Build 5 certification projects to earn your certificate.',
      instructor: 'FreeCodeCamp Team',
      platform: 'freecodecamp',
      url: 'https://www.freecodecamp.org/learn/responsive-web-design/',
      imageUrl: '/assets/images/fcc-responsive.jpg',
      price: 0,
      currency: 'USD',
      rating: 4.9,
      reviewCount: 25678,
    ...
    },
    {
      ...
      description: 'Master JavaScript fundamentals, ES6, regular expressions, debugging, data structures, and algorithms.',
      instructor: 'FreeCodeCamp Team',
      platform: 'freecodecamp',
      url: 'https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/',
      imageUrl: '/assets/images/fcc-js.jpg',
      price: 0,
      currency: 'USD',
      rating: 4.8,
      reviewCount: 23456,
    ...
    // Additional courses to reach 80+
    {
      ...
      imageUrl: '/assets/images/css-grid-course.jpg',
      price: 0,
      currency: 'USD',
      rating: 4.9,
      reviewCount: 8765,
    ...
    },
    {
      ...
      description: 'Build production-ready React applications with Next.js 14. Learn App Router, Server Components, and deployment.',
  ...
  private reviews: Review[] = [
    {
      ...
      content: 'This course covers everything you need to know about Angular. The instructor explains complex concepts clearly and provides practical examples.',
      pros: ['Great explanations', 'Practical examples', 'Up-to-date content', 'Good project structure'],
    ...
    },
    {
      ...
      content: 'Sarah explains React hooks in a way that finally made sense to me. The context API section was particularly helpful.',
      pros: ['Clear explanations', 'Good pacing', 'Free content', 'Practical examples'],
    ...
    },
    {
      ...
      content: 'Jonas is an amazing instructor. This course took my JavaScript skills from intermediate to advanced level.',
      pros: ['Comprehensive coverage', 'Excellent instructor', 'Real-world projects', 'Great exercises'],
    ...
    },
    {
      ...
      content: 'Great course for learning Node.js from scratch. Andrew covers all the important concepts with practical applications.',
      pros: ['Good structure', 'Practical projects', 'Clear explanations', 'Updated content'],
    ...
    },
    {
      ...
      content: 'Corey\'s teaching style is exceptional. This free course is better than many paid ones. Highly recommended!',
      pros: ['Free content', 'Excellent instructor', 'Comprehensive coverage', 'Good examples'],
    ...
    },
    {
      ...
      content: 'Angela makes Flutter accessible for beginners. The course structure is well thought out.',
      pros: ['Beginner friendly', 'Good projects', 'Clear explanations', 'Active community'],
    ...
    },
    {
      ...
      content: 'This course completely changed my career path. Jose explains complex data science concepts in simple terms.',
      pros: ['Career changing', 'Practical approach', 'Great projects', 'Comprehensive'],
    ...
    },
    {
      ...
      content: 'FreeCodeCamp\'s curriculum is incredible. The projects are challenging and teach real-world skills.',
      pros: ['Completely free', 'Hands-on projects', 'Great community', 'Certification'],
      cons: ['Self-paced can be challenging', 'No video explanations for some topics'],
      helpful: 123,
  ...
  getRecommendedCourses(userId: string, limit: number = 6): Observable<Course[]> {
  ...
  getCourseStats(): Observable<{
    ...
    const averageRating = this.courses.reduce((sum, course) => sum + course.rating, 0) / this.courses.length;
